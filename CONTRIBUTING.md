...
5. Never include credentials, tokens, private customer data, or unlicensed assets.
6. Run `bash tests/validate-repository.sh` and `bash scripts/validate-skills.sh` before submitting a change.
